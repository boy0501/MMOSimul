...
spawnAreaCenterX = 1286;   --이 좌표를 기준으로 일정 바운더리에서 태어나게 해줄거임.
spawnAreaCenterY = 210;  --이하 동일.
spawnWidth = 700;   --스폰 일정 바운더리
spawnHeight = 210;  --스폰 일정 바운더리
spawnX = 755;   --spawn좌표 건들지마세요
spawnY = 1454;  --spawn좌표 건들지마세요
Init_MaxHP = 20;    --이걸로 초기화할 생각
Init_Level = 1;     --이걸로초기화
Init_Name = "Norm1";    --이걸로 초기화
